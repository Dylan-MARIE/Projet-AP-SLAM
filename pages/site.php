        ...
        <ul>    
            <li class="deroulant">
                ...
                <ul class="sous">
                    ...
                    ?>
                    <li><a href="https://www.linkedin.com/in/dylan-marie-1a7386274/" target="_blank"><i class="fa-brands fa-linkedin"></i></a></li>
                    <li><a href="https://www.github.com/Dylan-MARIE" target="_blank"><i class="fa-brands fa-github"></i></a></li>
                </ul>
            </li>
        </ul> 
    </nav>
